 ...
 */
public class IMPictureUploader extends BaseFileUploader {
    public String filePath;
    public int actType = 1;
    public String ext = "jpg";
    public int groupId;

    public IMPictureUploader(@NonNull OnNginxUploadStateCallback callback) {
        super(callback);
    }
    ...
    protected int getOpType() {
        return OpTypeConfig.NGINX_OPTYPE_IM_PIC;
    }
