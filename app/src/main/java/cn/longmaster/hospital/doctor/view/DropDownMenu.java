...
public class DropDownMenu extends LinearLayout {
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_up_out));
            maskView.setVisibility(GONE);
            maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_up_out));
            ...
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_up_in));
                        maskView.setVisibility(VISIBLE);
                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.push_up_in));
