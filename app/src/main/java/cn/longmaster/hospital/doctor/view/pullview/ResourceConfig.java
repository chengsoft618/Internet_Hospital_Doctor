package cn.longmaster.hospital.doctor.view.pullview;
...
public abstract class ResourceConfig {
    ...
    private int[] configImageResIdsByDefault() {
        return new int[]{R.drawable.icon_xw_ptr_arrow, R.drawable.icon_xw_ptr_refresh_succeeded,
                R.drawable.icon_xw_ptr_refresh_failed, R.drawable.icon_xw_ptr_load_succeeded,
                R.drawable.icon_xw_ptr_load_failed};
    }
