...
public class DepartmentListRequester extends SimpleHttpRequester<List<DepartmentInfo>> {
    public int ownType;//0：指南库，1：我的资料

    public DepartmentListRequester(@NonNull OnResultListener<List<DepartmentInfo>> onResultListener) {
    ...
    protected int getOpType() {
        return OpTypeConfig.CLIENTAPI_OPTYE_GET_GUIDE_DEPARTMENT_LIST;
    }
