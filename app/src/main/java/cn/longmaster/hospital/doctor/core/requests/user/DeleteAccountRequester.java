 ...
 * wanghaikun
 */
public class DeleteAccountRequester extends SimpleHttpRequester<Void> {
    public String cardNum;
    public int account;

    public DeleteAccountRequester(@NonNull OnResultListener<Void> onResultListener) {
    ...
    protected int getOpType() {
        return OpTypeConfig.CLIENTAPI_OPTYE_DELETE_BANK_ACCOUNT;
    }
