...
import cn.longmaster.hospital.doctor.view.google.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
    ...
    private static void bundleThumbnail(PlanarYUVLuminanceSource source, Bundle bundle) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(pixels, 0, width, width, height, Bitmap.Config.ARGB_4444);
