 ...
 */
public class ConsultantCarryOnFragment extends NewBaseFragment {
    ...
    private void displaySearchData() {
        ...
        Logger.logI(Logger.COMMON, "ConsultantCarryOnFragment->onStart()-->searchScheduingInfo:" + mSearchScheduingInfo + ",visitScreenInfo:" + mVisitScreenInfo);
        displayData();
    }
    ...
    private void getConsultantScheduling(String beginDt, String endDt, int doctorId, String keyWord, String searchType) {
        ConsultantSchedulingRequester schedulingRequester = new ConsultantSchedulingRequester(new OnResultListener<ConsultantSchedulingInfo>() {
            @Override
            public void onResult(BaseResult baseResult, ConsultantSchedulingInfo SshedulingListInfos) {
                Logger.logI(Logger.COMMON, "ConsultantCarryOnFragment-->getConsultantScheduling-->SshedulingListInfos:" + SshedulingListInfos);
        ...
        schedulingRequester.statNum = AppConstant.ConsultantStatusType.APPOINTMENT_STATUS_TYPE_CARRY_ON;
