 ...
 */
public class CashRequester extends SimpleHttpRequester<Void> {
    ...
    public String incomeIds;

    public CashRequester(@NonNull OnResultListener<Void> onResultListener) {
    ...
    protected int getOpType() {
        return OpTypeConfig.CLIENTAPI_OPTYE_GET_ACCOUNT_CASH;
    }
    ...
    protected void onPutParams(Map<String, Object> params) {
        ...
        params.put("income_ids", incomeIds);
    }
}
