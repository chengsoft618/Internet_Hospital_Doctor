 ...
 */
public class DCDoctorListAdapter extends BaseSectionQuickAdapter<DCDoctorSectionInfo, BaseViewHolder> {
    ...
    public DCDoctorListAdapter(int layoutResId, int sectionHeadResId, List<DCDoctorSectionInfo> data) {
