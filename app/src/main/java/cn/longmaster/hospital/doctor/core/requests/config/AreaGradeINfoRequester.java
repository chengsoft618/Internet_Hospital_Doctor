 ...
 */
public class AreaGradeINfoRequester extends SimpleHttpRequester<List<AreaGradeInfo>> {
    public String token;//同步token标识

    public AreaGradeINfoRequester(@NonNull OnResultListener<List<AreaGradeInfo>> onResultListener) {
