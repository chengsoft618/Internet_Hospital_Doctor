 ...
 * @author ABiao_Abiao
 * @date 2019/8/6 9:29
 * @description: DuwsUrlRequester
 */
public abstract class BaseDuwsUrlRequester<Data> extends HttpRequester {
    private OnResultCallback<Data> onResultListener;

    public BaseDuwsUrlRequester(@NonNull OnResultCallback<Data> onResultListener) {
