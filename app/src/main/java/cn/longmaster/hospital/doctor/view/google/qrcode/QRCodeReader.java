...
package cn.longmaster.hospital.doctor.view.google.qrcode;
...
import cn.longmaster.hospital.doctor.view.google.ChecksumException;
import cn.longmaster.hospital.doctor.view.google.DecodeHintType;
import cn.longmaster.hospital.doctor.view.google.FormatException;
import cn.longmaster.hospital.doctor.view.google.NotFoundException;
import cn.longmaster.hospital.doctor.view.google.Reader;
import cn.longmaster.hospital.doctor.view.google.Result;
import cn.longmaster.hospital.doctor.view.google.ResultMetadataType;
import cn.longmaster.hospital.doctor.view.google.ResultPoint;
import cn.longmaster.hospital.doctor.view.google.common.BitMatrix;
import cn.longmaster.hospital.doctor.view.google.common.DecoderResult;
import cn.longmaster.hospital.doctor.view.google.common.DetectorResult;
import cn.longmaster.hospital.doctor.view.google.qrcode.decoder.Decoder;
import cn.longmaster.hospital.doctor.view.google.qrcode.decoder.QRCodeDecoderMetaData;
import cn.longmaster.hospital.doctor.view.google.qrcode.detector.Detector;
            ...
            if (activity != null && activity.isAutoEnlarged()) {
                ...
                if (frameRect != null) {
                    ...
                    if (parameters.isZoomSupported()) {
                        if (len <= frameWidth / 6) {//二维码在扫描框中的宽度小于扫描框的1/5，放大镜头
                            if (zoom == 0) {
                                zoom = maxZoom / 10;
