 ...
 */
public class RoundsReturnVisitFragment extends NewBaseFragment {
    ...
    public static RoundsReturnVisitFragment getInstance(boolean mIsRoom, String visitUrl) {
        RoundsReturnVisitFragment roundsReturnVisitFragment = new RoundsReturnVisitFragment();
    ...
    protected void initDatas() {
        ...
        if (bundle != null) {
            mCurrentLoadUrl = bundle.getString(ExtraDataKeyConfig.EXTRA_DATA_KEY_LOADING_URL);
            Logger.logI(Logger.APPOINTMENT, "mBasicMedicalInfo:" + mBasicMedicalInfo);
        }
    }
    ...
    private void initWebView() {
        ...
        mBrowserWv.setDownloadListener(new RoundsReturnVisitFragment.MyWebViewDownLoadListener());
