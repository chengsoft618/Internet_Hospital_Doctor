 ...
 */
public class DeleteSchedulingRequester extends SimpleHttpRequester<Void> {
    public int scheduingId;//排班ID

    public DeleteSchedulingRequester(@NonNull OnResultListener<Void> onResultListener) {
    ...
    protected int getOpType() {
        return OpTypeConfig.CLIENTAPI_OPTYE_DELETE_SCHEDULING;
    }
