...
public class ConfirmListItem implements Parcelable {
    ...
    protected ConfirmListItem(Parcel in) {
    ...
    public static final Parcelable.Creator<ConfirmListItem> CREATOR = new Parcelable.Creator<ConfirmListItem>() {
        @Override
        public ConfirmListItem createFromParcel(Parcel source) {
            return new ConfirmListItem(source);
        }

        @Override
        public ConfirmListItem[] newArray(int size) {
            return new ConfirmListItem[size];
        }
    };
}
