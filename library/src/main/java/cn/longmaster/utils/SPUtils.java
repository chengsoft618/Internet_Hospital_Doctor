 ...
 *     time  : 2016/08/02
 *     Detail  : utils about shared preference
 * </pre>
 */
@SuppressLint("ApplySharedPref")
public final class SPUtils {

    private static final HashMap<String, SPUtils> SP_UTILS_MAP = new HashMap<>();
    private SharedPreferences sp;
    private static final boolean isApply = false;
    private static final boolean isCommit = true;
    private static boolean defaultPut = isApply;
    ...
    private SPUtils(final String spName, final int mode) {
        checkNotNull(Utils.getApp(), "Application can not be null");
