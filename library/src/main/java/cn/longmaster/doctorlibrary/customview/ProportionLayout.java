package cn.longmaster.doctorlibrary.customview;
...
public class ProportionLayout extends ViewGroup {
    ...
    public ProportionLayout(Context context, AttributeSet attrs) {
        ...
        setOrientation(typedArray.getInt(R.styleable.ProportionLayout_orientation, HORIZONTAL));
