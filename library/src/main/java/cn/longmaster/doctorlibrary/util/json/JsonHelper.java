...
public class JsonHelper {
    ...
    public static JSONObject toJSONObject(Object object) {
        ...
        Logger.logD(TAG, "#toJSONObject cast time:" + (TimeUtils.getNowMills() - time));
        return jsonObject;
    }
    ...
    public static JSONArray toJSONArray(List<?> datas) {
        ...
        Logger.logD(TAG, "#toJSONArray cast time:" + (TimeUtils.getNowMills() - time));
        return jsonArray;
    }
    ...
    public static <V> List<V> toList(JSONArray jsonArray, Class<V> entityType) {
        ...
        Logger.logD(TAG, "#toList cast time:" + (TimeUtils.getNowMills() - time));
        return list;
    }
    ...
    public static <V> V toObject(JSONObject jsonObject, Class<V> entityType) {
            ...
            while (currentClass != Object.class) {
                ...
                for (Field field : fields) {
                    try {
                        ...
                        Object o = jsonObject.opt(fieldName);
                        if (o == null || o.equals(JSONObject.NULL)) {
                            // 跳过json中不存在的字段和null
                            continue;
                        }
                        String StringObject = jsonObject.optString(fieldName);
                        try {
        ...
        Logger.logD(TAG, "#toObject cast time:" + (TimeUtils.getNowMills() - time));
        return v;
    }
    ...
    private static Object getJavaObject(String jsonString, Class<?> targetType, Field field) throws JSONException,
        ...
        if (targetType == Integer.class || targetType == int.class) {
            ...
            if (jsonString.startsWith("[") && jsonString.endsWith("]")) {
                ...
                result = Array.newInstance(targetType.getComponentType(), 0);
            }
            ...
            if (jsonString.startsWith("{") && jsonString.endsWith("}")) {
                ...
                throw new RuntimeException(jsonString + "不能为转换为：" + targetType);
            }
        }
        return result;
    }
