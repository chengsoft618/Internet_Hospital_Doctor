...
import cn.longmaster.cameralibrary.util.AngleUtil;
import cn.longmaster.cameralibrary.util.CameraParamUtil;
import cn.longmaster.cameralibrary.util.CheckPermission;
import cn.longmaster.cameralibrary.util.DeviceUtil;
        ...
        if (mCamera != null) {
            try {
                ...
                Camera.Size previewSize = CameraParamUtil.getInstance().getPreviewSize(mParams
                        .getSupportedPreviewSizes(), 1500, screenProp);
                ...
                for (int i = 0; i < mParams.getSupportedPictureSizes().size(); i++) {
                    Log.i(TAG, "=== mParams. ===" + mParams.getSupportedPictureSizes().get(i).width + "*" + mParams.getSupportedPictureSizes().get(i).height);
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
